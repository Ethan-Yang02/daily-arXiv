...
- 🌍 **Complete English Support**: Full English experience across the project  
  - Notifications and reports are fully available in English  
...
### 9. Deploy as systemd services (Linux)
...
The deployment script will fail fast with explicit errors for common issues (for example, missing system commands or invalid Python environment).

### 10. Uninstall systemd services (Linux)
...
View generated reports in the `data/` directory.
...
- [x] Complete English support ✅  
  - Notifications, logs, prompts, reports, and documentation are fully available in English  
...
- Full English support has been completed and synchronized across all docs and prompts.
